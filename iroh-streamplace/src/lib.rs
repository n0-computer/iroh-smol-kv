...
pub struct SpSubscribeResponse {
    inner: Mutex<
        Pin<
            Box<
...
impl std::fmt::Debug for SpSubscribeResponse {
...
impl Db {
    ...
    pub fn subscribe(&self, filter: Arc<Filter>) -> Arc<SpSubscribeResponse> {
    ...
    pub fn subscribe_with_opts(&self, opts: SubscribeOpts) -> Arc<SpSubscribeResponse> {
        Arc::new(SpSubscribeResponse {
